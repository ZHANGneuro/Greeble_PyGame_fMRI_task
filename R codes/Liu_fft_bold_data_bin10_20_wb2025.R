...
for (ith_sub in c(1:28, 30, 32:35)) {
  result_table <- read.table(paste("/Users/bo/Documents/data_liujia_lab/analysis_liuP1_greeble/MRI_results_FFT/MRI_results_formal/bold_angle_perio_bin10_sub", ith_sub,"_subj_z_wb.txt", sep = ""), stringsAsFactors = FALSE)
  ...
  for (ith_win_size in c(0)) {  
    ...
    write.table(export_table, file = paste("/Users/bo/Documents/data_liujia_lab/analysis_liuP1_greeble/MRI_results_FFT/MRI_results_formal/fft_value_wb_bin10_sub", as.character(ith_sub),"_wb_win_size_", as.character(ith_win_size),"_subj.txt", sep = ""),
...
for (ith_sub in  c(1:28, 30, 32:35)) {
  result_table <- read.table(paste("/Users/bo/Documents/data_liujia_lab/analysis_liuP1_greeble/MRI_results_FFT/MRI_results_formal/bold_angle_perio_bin20_sub", ith_sub,"_subj_z_wb.txt", sep = ""), stringsAsFactors = FALSE)
  ...
  for (ith_win_size in c(0)) {  
    ...
    write.table(export_table, file = paste("/Users/bo/Documents/data_liujia_lab/analysis_liuP1_greeble/MRI_results_FFT/MRI_results_formal/fft_value_wb_bin20_sub", as.character(ith_sub),"_wb_win_size_", as.character(ith_win_size),"_subj.txt", sep = ""),
                row.names = FALSE, col.names = FALSE, quote=FALSE)
    print(ith_sub)
  }
}
