...
for (ith in c(1:28,30, 32:35)) {
  ...
  write.table(result_table, paste("/Users/bo/Documents/data_liujia_lab/analysis_liuP1_greeble/sub", ith,"_mri_record_subj_vector_mean_testing_para",para,"_1_35_bin10.txt", sep = ""), sep='\t', row.names=FALSE, col.names = FALSE, quote = FALSE)
}
