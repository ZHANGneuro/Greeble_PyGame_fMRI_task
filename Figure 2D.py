...
# df.to_excel("/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/submission_elife/figs/Figure 2-source data 2.xlsx", index=False, header=False)
# #

xx = np.mean(data_set, axis=0)
se = np.std(data_set, axis=0)/np.sqrt(num_sub)
gray_color = (115/255, 115/255, 115/255)
cur_color = (188/255, 48/255, 117/255)
bar_colors = [cur_color, gray_color, cur_color, gray_color, cur_color, gray_color, cur_color, gray_color, cur_color, gray_color, cur_color, gray_color]
