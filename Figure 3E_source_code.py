...
cur_path = Path.cwd() / "data" / "bar_3_fold_para34567.txt"
...
# df.to_excel("/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/submission_elife/figs/Figure 3-source data 1.xlsx", index=False, header=False)
...
bar_colors[0]= np.round((145/255, 248/255, 89/255), 2)
