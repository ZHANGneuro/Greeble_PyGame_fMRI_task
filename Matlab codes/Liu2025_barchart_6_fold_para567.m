...
for ith_freq = 3:7
    keyword = 'vector';
    root_path = ['/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/periodic_2501_testing_',num2str(ith_freq),'_fieldmap_',keyword,'_mean/'];
    mask = MRIread('/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/mask/mask_MTL_bigger_full2.nii'); %mask_nowm_withsubc mask_wholebrain mask_MTL_bigger_full2.nii
    mask = mask.vol;
    % num_sub=[1:35];
...
% erc_r_struct = MRIread('/Users/bo/Documents/brainmask/mask_ERC_fun_sinusoid.nii'); % mask_ERC_harddraw_2mm_r mask_ERC_harddraw_2mm mask_ERC_fun_sinusoid
% erc_r_ima = erc_r_struct.vol;
% mask_index = find(erc_r_ima==1);

%% export txt
root_path_3 = '/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/periodic_2501_testing_3_fieldmap_vector_mean/';
root_path_4 = '/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/periodic_2501_testing_4_fieldmap_vector_mean/';
root_path_5 = '/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/periodic_2501_testing_5_fieldmap_vector_mean/';
root_path_6 = '/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/periodic_2501_testing_6_fieldmap_vector_mean/';
root_path_7 = '/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/periodic_2501_testing_7_fieldmap_vector_mean/';
...
mean_vector./std(export_txt, [], 1)

[H,P,CI,STATS] = ttest(export_txt, 0, 'Dim', 1, 'Tail','both');

fileID = fopen('/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/bar_6_fold_para34567_ERC_handdraw.txt','w');
% fileID = fopen('/Users/bo/Documents/data_liujia_lab/manuscript_gridcell3hz/analysis_liuP1_greeble/MRI_result_sinusoid/bar_6_fold_para34567_func.txt','w');
for ith = 1:num_sub
