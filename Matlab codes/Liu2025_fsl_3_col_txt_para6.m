...
for sub = 1:35
    for sess = 1:2:8
        ...
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_sin3', output_key_word,'.txt'],'w');
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_cos3', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_sin4', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_cos4', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_sin5', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_cos5', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_sin6', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_cos6', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_sin7', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
        ...
        dura = target_end - target_onset;
        export_txt = [target_onset, dura, sin_value_continuous];
        fid = fopen([  mypath,  '/MRI_event_timing_file2022/sub',num2str(sub), '_s', num2str(sess), '_subj_cos7', output_key_word,'.txt'],'w');
        for n = 1:length(export_txt(:,1))
            fprintf(fid,'%f\t  %f\t  %d\n',export_txt(n,:));
        end
        fclose(fid);
