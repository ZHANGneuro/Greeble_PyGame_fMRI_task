...
% cur_struct = MRIread('/Users/bo/Documents/brainmask/mask_hpc_fun_sinusoid.nii');%
%/Users/bo/Documents/data_liujia_lab/analysis_liuP1_greeble/MRI_results_FFT/new_stat_fft_subj_wide_mtl/Corr_bin10_g123_freq3_ws0_clustere_corrp_tstat1_binary_wr_c8r.nii.gz
...
for sub_ith = 1:length(sub_pool)
    ...
    for sess = 2:2:8
        % access raw table
        mypath_time_record =   [mypath, '/sub', num2str(cur_sub), '_mri_record_subj_vector_mean_testing_para3_1_35.txt'];
...
fileID = fopen([mypath, '/fig_main_mri/txt_barchart_3_fold_effect_erc_handdraw_g12_2025.txt'],'w');
