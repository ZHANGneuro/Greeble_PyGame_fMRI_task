...
for sub in {1..20}; do
  ...
  NUM_VOXEL=${voxel_num_pool[$sub]}
    ...
    TEMPLATE_PATH="/Users/bo/Documents/bash_script/batch_oscill_fieldmap_template_bin20.fsf"
    OUTPUTDIR=$server_root"/liujia_pilot_sub"$ith_sub_str"/oscill_fieldmap_obj_bin20"
    ...
    -e 's@BOLD_IMAGE@'$BOLD_IMAGE'@g' <$TEMPLATE_PATH> /Users/bo/Documents/bash_script/template_liujia_osci_bin20/fsf_osci_bin20_sub$sub".fsf"
done
