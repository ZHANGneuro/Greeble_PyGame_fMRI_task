...
for sub in 25 29; do
  ...
  NUM_VOXEL=${voxel_num_pool[$sub]}
    ...
    TEMPLATE_PATH="/Users/bo/Documents/script_bash/batch_oscill_fieldmap_template_bin10.fsf"
    OUTPUTDIR=$server_root"/liujia_formal_sub"$sub"/oscill_fieldmap_obj_bin10"
    ...
    -e 's@BOLD_IMAGE@'$BOLD_IMAGE'@g' <$TEMPLATE_PATH> /Users/bo/Documents/script_bash/template_osci2025/fsf_osci_bin10_sub$sub".fsf"
done
